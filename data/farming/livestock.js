module.exports = {
  dairy_cows: {
    ...
    capacityBase: 6,
    productionHours: 6,
    lifecycleHours: { juvenile: 36, adult: 72, elderly: 240, death: 336 },
  ...
  chickens: {
    ...
    capacityBase: 18,
    productionHours: 4,
    lifecycleHours: { juvenile: 12, adult: 24, elderly: 96, death: 144 },
  ...
  sheep: {
    ...
    capacityBase: 10,
    productionHours: 8,
    lifecycleHours: { juvenile: 24, adult: 48, elderly: 168, death: 240 },
