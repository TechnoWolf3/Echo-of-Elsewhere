module.exports = {
  ...
  echo_blessing_lucky_multiplier: {
    id: 'echo_blessing_lucky_multiplier',
    ...
    defaultUseUses: true,
    defaultUses: 1,
    defaultAwardWeight: 0,
    awardLines: [
      '✨ **{effectName}** locks in. Your next eligible payout is doubled.',
      '💫 Echo marks your next reward for excess. **{effectName}** will trigger once.',
    ],
    refreshLines: [
      '✨ **{effectName}** is refreshed. Your next eligible payout will still be doubled.',
    ],
  },
  echo_curse_account_frozen: {
    id: 'echo_curse_account_frozen',
    name: 'Account Frozen',
    type: 'curse',
    enabled: true,
    target: 'money_reward',
    ...
    defaultUseTime: true,
    defaultUseUses: false,
    defaultDurationMinutesRange: [10, 20],
    defaultAwardWeight: 0,
    awardLines: [
      '🧊 **{effectName}** clamps down on your earnings. Eligible payouts are frozen until {expiresRelative}.',
      '📛 Your earnings are iced over. **{effectName}** lifts {expiresRelative}.',
    ],
    rejectSameCurseLines: [
      '🧊 Your earnings are already frozen solid. Echo leaves them there.',
    ],
  },
  echo_blessing_casino_voucher: {
    id: 'echo_blessing_casino_voucher',
    name: 'Casino Voucher',
    type: 'blessing',
    enabled: true,
    target: 'trigger_event',
    modifierMode: 'refund_on_loss',
    defaultValue: 1,
    defaultUseTime: true,
    defaultUseUses: true,
    defaultDurationMinutesRange: [60, 180],
    defaultUses: 1,
    defaultAwardWeight: 0,
    triggers: ['casino_loss'],
    awardLines: [
      '🎟️ **{effectName}** is tucked into your pocket until {expiresRelative}. Your next casino loss will be refunded.',
      '💳 Echo issues a one-use **{effectName}**. Your next casino loss is covered until {expiresRelative}.',
    ],
    refreshLines: [
      '🎟️ **{effectName}** is refreshed. Your next casino loss is still covered until {expiresRelative}.',
    ],
    triggerLines: [
      '🎟️ **{effectName}** tears itself in half and refunds **{refundAmount}** from that loss.',
      '💳 The voucher cashes in. **{refundAmount}** is returned to your wallet.',
    ],
  }
};
