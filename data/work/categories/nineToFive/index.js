  ...
  jobs: [
    {
      ...
      desc: "3-step choices (risk/reward). 10m cooldown.",
      button: { id: "job_95:contract", label: "🚚 Transport" },
    },
    {
      key: "skillCheck",
      title: "🧩 Skill Check",
      desc: "3-colour memory test. 5m cooldown.",
      button: { id: "job_95:skill", label: "🧩 Skill Check" },
    },
    {
      key: "shift",
      title: "🕒 Shift",
      desc: "45-second shift, then Collect Pay. 6m cooldown.",
      button: { id: "job_95:shift", label: "🕒 Shift" },
    },
    {
      key: "emailSorter",
      title: "📧 Email Sorter",
      desc: "Read the email, trust the clues, sort the folder. 8m cooldown.",
      button: { id: "job_95:emailSorter", label: "📧 Email Sorter" },
    },
    {
      key: "trucker",
      title: "🚛 Trucker",
      desc: "$12/km. 1 minute per 100km, minimum 3 minutes.",
